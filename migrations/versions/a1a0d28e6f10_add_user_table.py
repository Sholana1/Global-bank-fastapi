...
Revision ID: a1a0d28e6f10
Revises: 
Create Date: 2026-01-17 15:01:35.628506
...
def upgrade() -> None:
    ...
    sa.Column('security_question', sa.Enum('MOTHER_MAIDEN_NAME', 'CHILDHOOD_FRIEND', 'FAVORITE_COLOR', 'BIRTHCITY', name='securityquestionschema'), nullable=False),
    sa.Column('security_answer', sqlmodel.sql.sqltypes.AutoString(length=30), nullable=False),
    sa.Column('account_status', sa.Enum('ACTIVE', 'INACTIVE', 'SUSPENDED', 'PENDING', name='accountstatusschema'), nullable=False),
    sa.Column('role', sa.Enum('CUSTOMER', 'ACCOUNT_EXECUTIVE', 'BRANCH_MANAGER', 'ADMIN', 'SUPER_ADMIN', 'TELLER', name='rolechoiceschema'), nullable=False),
